<template>
    <div>
        <Navbar />
        <div
            class="w-screen flex items-center justify-center px-6 py-4 bg-white rounded shadow-md ring-1 ring-gray-900/10"
        >
...
export default {
    ...
    methods: {
        ...
        submit() {
            ...
            axios
                .put(
                    `https://ejohncarlsrizz.pythonanywhere.com/person/${this.id}/`,
                    {
