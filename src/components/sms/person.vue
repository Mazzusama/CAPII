                    ...
                    <form @submit.prevent="submit">
                        <div class="mb-4 w-full">
                            <label
                                ...
                                for="recipients"
                                >Send SMS to a Person</label
                            >
                            <input
                                v-model="phone_number"
                                class="w-full p-2 border border-gray-900 bg-slate-400 placeholder-gray-500 text-lg font-semibold"
...
export default {
    ...
    methods: {
        ...
        submit() {
            axios
                .post(
                    `https://ejohncarlsrizz.pythonanywhere.com/sms/`,
                    {
