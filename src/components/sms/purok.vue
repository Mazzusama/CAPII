                ...
                <div class="w-full my-2">
                    <form @submit.prevent="submit">
                        <div class="mb-4 w-full">
                            <label
                                class="text-center w-full block font-bold mb-2 bg-secondary p-1"
                                for="recipients"
                                >Send SMS by Purok</label
                            >
                            <select
                                v-model="purok"
                                class="w-full p-2 border border-gray-900 bg-slate-400 text-lg font-semibold"
                            >
                                <option disabled selected value="">
                                    Select a purok
                                </option>
                                <option class="text-sm font-semibold">
                                    Purok 1
                                </option>
                                <option class="text-sm font-semibold">
                                    Purok 2
...
export default {
    ...
    methods: {
        ...
        //       this.purokList = response.data.data;
        //       })
        //       .catch((error) => {
        //         console.log(error);
        //       });
        ...
        submit() {
            axios
                .post(
                    `https://ejohncarlsrizz.pythonanywhere.com/sms/purok/`,
                    {
                        purok: this.purok,
