<template>
    <div>
        <Navbar />
        <div
            class="w-auto flex items-center justify-center px-6 py-4 bg-white rounded shadow-md ring-1 ring-gray-900/10"
        >
            <form @submit.prevent="submit" class="h-96 overflow-y-auto">
                <div class="overflow-y-auto max-h-screen-3/4">
                    <div>
                        <label
                            class="block w-full uppercase bg-gray-200 text-lg font-bold text-gray-700 p-4 text-center"
                        >
                            ...
                            <div class="grid grid-cols-4 bg-yellow-200">
                                ...
                                >
                                    <input
                                        ...
                                        multiple
                                        :value="labor.id"
                                        class="m-2 form-checkbox h-4 w-4 text-gray-600 bg-slate-300"
                                    />
                        ...
                        <div class="flex flex-col">
                            ...
                            <div
                                class="grid grid-cols-5 bg-blue-300 p-2 rounded-md"
                            >
                                <label
